...
_BREAK_ADJUST = {
    ...
    '官星逢合': '比劫',          # "透官而又逢合"——比劫争合解官合
    '透煞生印又透财': '比劫',    # "透煞生印又透财"——比劫夺财护印
    # ── 新增破格带忌（依据《子平真诠》第九章带忌）──
    '伤轻身旺佩印': '食伤',      # 伤轻身旺佩印 → 食伤泄身制印
    '伤官生财财逢合': '比劫',    # "伤官生财而财又逢合" → 比劫争合解财合
    '食制逢印': '财星',          # "七煞逢食制而又逢印" → 财制印护食
    '煞印逢财': '比劫',          # "食神带煞印而又逢财" → 比劫夺财护印
    '羊刃无官煞': '官杀',        # "阳刃无官煞" → 官杀制刃
    # ── 从格/化气格破格 ──
