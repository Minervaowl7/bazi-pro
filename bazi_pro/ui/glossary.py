...
# ── 紫微斗数 ──
_g('命宫', '命盘的核心宫位', '紫微斗数十二宫之首，代表命主的先天性格、气质和人生总纲。命宫主星是分析的核心起点。', '紫微斗数')
_g('身宫', '后天努力的方向', '紫微斗数中代表命主后天发展的着力点，与命宫共同决定人生走向。身宫落在哪个宫位，代表该领域是后天重点。', '紫微斗数')
_g('紫微星', '帝王之星', '紫微斗数的主星之首，代表尊贵、领导力和大局观。紫微星入命宫者，往往有王者气质和统筹能力。', '紫微斗数')
_g('天机星', '智慧之星', '紫微斗数主星之一，代表聪明、善变和策划能力。天机星入命宫者，思维敏捷、善于谋略。', '紫微斗数')
_g('太阳星', '光明之星', '紫微斗数主星之一，代表热情、博爱和奉献精神。太阳星入命宫者，性格开朗、乐于助人。', '紫微斗数')
_g('武曲星', '财帛之星', '紫微斗数主星之一，代表刚毅、果断和理财能力。武曲星入命宫者，重义守信、善于经营。', '紫微斗数')
_g('天同星', '福德之星', '紫微斗数主星之一，代表温和、知足和享受生活。天同星入命宫者，心态平和、追求安逸。', '紫微斗数')
_g('廉贞星', '次桃花之星', '紫微斗数主星之一，代表多才、情绪化和人际关系。廉贞星入命宫者，才华横溢但情感丰富。', '紫微斗数')
_g('天府星', '库藏之星', '紫微斗数主星之一，代表稳重、包容和守成能力。天府星入命宫者，性格沉稳、善于积累。', '紫微斗数')
_g('太阴星', '月亮之星', '紫微斗数主星之一，代表细腻、内敛和感性。太阴星入命宫者，心思细腻、富有同情心。', '紫微斗数')
_g('贪狼星', '桃花之星', '紫微斗数主星之一，代表多才多艺、交际广泛和欲望强烈。贪狼星入命宫者，兴趣广泛、魅力十足。', '紫微斗数')
_g('巨门星', '口舌之星', '紫微斗数主星之一，代表口才、分析能力和是非争议。巨门星入命宫者，言辞犀利、善于表达。', '紫微斗数')
_g('天相星', '印星', '紫微斗数主星之一，代表正直、服务精神和协调能力。天相星入命宫者，为人正直、善于调解。', '紫微斗数')
_g('天梁星', '荫星', '紫微斗数主星之一，代表荫庇、化解灾厄和正义感。天梁星入命宫者，有逢凶化吉的能力。', '紫微斗数')
_g('七杀星', '将星', '紫微斗数主星之一，代表冲劲、魄力和开创精神。七杀星入命宫者，个性刚烈、勇于突破。', '紫微斗数')
_g('破军星', '耗星', '紫微斗数主星之一，代表变动、破坏和重建。破军星入命宫者，不安于现状、善于破旧立新。', '紫微斗数')
_g('化禄', '四化之禄', '四化星之一，代表收获、顺利和财运。化禄入哪个宫位，该领域容易获得回报和满足。', '紫微斗数')
_g('化权', '四化之权', '四化星之一，代表权力、掌控和主动性。化权入哪个宫位，该领域容易获得主导权和影响力。', '紫微斗数')
_g('化科', '四化之科', '四化星之一，代表名声、贵人和学业。化科入哪个宫位，该领域容易获得认可和好名声。', '紫微斗数')
_g('化忌', '四化之忌', '四化星之一，代表困扰、执着和损失。化忌入哪个宫位，该领域容易遇到阻碍和纠结。', '紫微斗数')
_g('大限', '紫微的大运', '紫微斗数中每十年为一个大限，代表人生不同阶段的运势主题。大限宫位和主星变化影响该阶段的吉凶。', '紫微斗数')
_g('流年', '每年的运势', '紫微斗数中每年的运势变化，由流年命宫和四化星决定。流年影响比大限更细致，反映年度吉凶。', '紫微斗数')
_g('五行局', '命盘的能量属性', '紫微斗数中根据命宫干支推算出的五行属性（如水二局、木三局等），决定命盘的基本能量格局和星曜亮度。', '紫微斗数')
_g('命主', '先天命盘的主导星', '紫微斗数中根据出生时辰推算的先天主星，代表命主的先天特质和潜在能力。', '紫微斗数')
_g('身主', '后天发展的主导星', '紫微斗数中根据出生年支推算的后天主星，代表命主后天努力的方向和外在表现。', '紫微斗数')
_g('紫微斗数', '星辰命理学', '中国传统命理学的重要分支，以出生时间排布十二宫和星曜，分析性格、事业、感情等人生各方面。与八字命理并列为两大命理体系。', '紫微斗数')
_g('星曜', '紫微斗数的星辰', '紫微斗数中的各类星辰，包括十四主星和众多辅星。每颗星曜有特定的性质和影响力，落在不同宫位产生不同效果。', '紫微斗数')
_g('宫位', '人生的十二个领域', '紫微斗数将人生分为十二个宫位（命宫、兄弟宫、夫妻宫等），每个宫位代表生活的特定方面。星曜落入不同宫位，影响该领域的吉凶。', '紫微斗数')
...
def render_glossary_section(used_terms: set[str]) -> str:
    ...
    category_order = ['十神', '旺衰', '格局', '用神', '关系', '五行', '大运', '概念', '紫微斗数']
    category_labels = {
        '十神': '十神（人际关系与能力类型）',
        '旺衰': '旺衰（自身力量强弱）',
        '格局': '格局（人生发展模式）',
