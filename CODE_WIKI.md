...
> 项目：bazi-pro v5.2.0 — 可审计、可交互、可视化的八字命理分析引擎（典籍对齐版）
> 文档生成时间：2026-05-29
...
| **项目名称** | bazi-pro |
| **版本** | v5.2.0 |
| **定位** | 确定性八字命理计算引擎 + LLM 解读框架 + Web 应用（典籍对齐版） |
| **核心原则** | **算析分离** — `bazi_pro/core/` 做所有确定性命理计算，LLM 只负责解读，不参与计算 |
| **核心能力** | BM25+Hybrid 古籍检索、六层格局筛查、四层喜用神裁决、格局之病检测、调候用神查表、确定性叙述器、交互式仪表盘、证据链输出、**多流派分析（盲派/新派典籍对齐）** |
