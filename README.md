...
**v5.3 亮点**：核心格局判定逻辑三项古籍对齐修正——会方检测收紧（移除"任意三同五行地支即会方"的过度放宽，对齐《滴天髓》"方是方兮局是局"）· 从强格增加官杀力量guard（官杀≥15%不判从强，对齐《渊海子平》"官印双全"）· 三刑优先于两两相刑（对齐《三命通会》"三刑者三支相刑也"）· 阴干墓库扣分加深（对齐《滴天髓》"阴逢库为无用"）· 调候用神自动整合到喜神（对齐《子平真诠》"论用神配气候得失"）。120 Golden Cases 全部通过。
