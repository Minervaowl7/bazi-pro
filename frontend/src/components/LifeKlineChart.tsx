      ...
      xAxis: [
        {
          ...
          data: xLabels,
          gridIndex: 0,
          axisLine: { lineStyle: { color: "#28283a" } },
          axisLabel: {
            color: "#606070",
            fontSize: 11,
            interval: 9,
      ...
      yAxis: [
        {
          ...
          min: 0,
          max: 100,
          splitLine: { lineStyle: { color: "#28283a", type: "dashed" } },
          axisLine: { show: false },
          axisLabel: { color: "#606070", fontSize: 11 },
          axisTick: { show: false },
        },
        {
          type: "value",
