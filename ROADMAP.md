> ⚠️ v5.0 重构已于 2025-05 完成。核心变更：确定性命理计算核心 (bazi_pro/core/)、83 Golden Cases、Pydantic API Schema、三层职责边界。详见 git log。
...
| 阶段 | 主题 | 状态 | 优先级 |
|------|------|:----:|:------:|
| Phase A | 视觉与交互升级 | ✅ 已完成 | P0 |
| Phase B | 技术架构升级 | ✅ 已完成 | P1 |
| Phase C | 功能创新 | ✅ 已完成 | P2 |
| Phase D | 开发者生态 | ✅ 已完成 | P3 |
...
| v4.7 | B-2 + B-3 架构统一 | ✅ |
| v4.8 | C-1 + C-3 新功能 | ✅ |
| v5.0 | C-2 + C-4 + D-1~D-3 — 完整生态闭环 | ✅ 当前版本 |
